...
<div class=\"acf-<?= layout() ?>__container container max-w-container-lg z-3 mx-auto w-full overflow-hidden flex
    flex-col relative\">
    <?php elseif (get_sub_field('container') === 'medium') : ?>
    <div class=\"acf-<?= layout() ?>__container container max-w-container-md z-3 mx-auto w-full overflow-hidden flex
        flex-col relative\">
        <?php elseif (get_sub_field('container') === 'none') : ?>
        <div class=\"max-w-full mx-auto z-3 w-full overflow-hidden flex flex-col relative\">
            <?php endif; ?>";
            });
